...
1. What's the model's AUC? 0.73
2. At threshold 0.50, what's the sensitivity and specificity? 0.817 and 0.492
3. Which racial group has the highest false positive rate? Black
4. Which group has the highest false negative rate? White
5. What happens if we change the threshold to 0.30 or 0.70? Precision decreases when 0.3 and increases when 0.7
...
No. Overall Accuracy is too low and this is a high-stakes decision.

True negative is low too.
...
Group Black has 13.7% points higher false positive rate than Group White
...
Black people are affected disproportionately by this.
