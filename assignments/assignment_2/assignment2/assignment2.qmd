...
# Check that all data loaded correctly #####1
glimpse(pa_counties)
glimpse(hospitals)
...
- What coordinate reference system is each dataset in?
  - PA county boundaries CRS: GCS WGS 84 (Pseudo-Mercator) / EPSG 4326. 
...
- What income threshold did you choose and why?
  - I used a quantile based rule to flag relatively low incomes within Pennsylvania. The cutoff is the lowest 25 percent of tract median incomes. With 2022 data this equals $55924. This method is future proof because the threshold updates automatically as new data arrive.

- What elderly population threshold did you choose and why?
  - I used the same quantile approach as before but focused on the share of residents aged 65 and above. Tracts in the highest 25 percent for elderly population were identified as having a significant older population. With 2022 data this threshold corresponds to 23.1 percent of residents being 65 years or older.

- How many tracts meet your vulnerability criteria?
  - A total of 165 tracts meet both vulnerability criteria, which include having income in the lowest 25 percent of Pennsylvania census tracts and an elderly population in the highest 25 percent.

- What percentage of PA census tracts are considered vulnerable by your definition?
  - These tracts make up about 4.8 percent of all Pennsylvania census tracts, with 165 out of 3,445 meeting the definition.
...
- Explain why you chose your projection
  - I used NAD83 Pennsylvania South EPSG 3365 for the statewide analysis. Pennsylvania has two State Plane zones that minimize distortion across its wide east to west extent. Instead of performing separate analyses for each zone I applied the South zone projection to the entire state to maintain consistency and efficiency while keeping measurement accuracy reasonable. This choice causes some distortion in the northern counties but it remains within acceptable limits for this analysis.
...
- Does this surprise you? Why or why not?
  - I wasn't surprised. I examined the counties that contain these underserved tracts and found that most are located in rural Pennsylvania where an aging population and lower income levels are more common. These areas also tend to have greater distances between communities and hospitals which helps explain the limited access.
...
- Which 5 counties have the highest percentage of underserved vulnerable tracts?
  - 18 counties have the same percentage of vulnerable tracts that are underserved. Those 18 counties are printed above.

- Which counties have the most vulnerable people living far from hospitals?
  - Fayette, Northumberland, Westmoreland, and Clearfield, and Somerset.

- Are there any patterns in where underserved counties are located?
  - Most of the counties are large rural counties.
...
```
Vulnerable tracts refer to areas that fall within the lowest quarter of median household income and the highest quarter of population aged sixty-five and older. Underserved tracts describe those vulnerable areas where residents live more than fifteen miles from the closest hospital.
...
tracts_with_data %>%
  ...
  labs(
    ...
    caption = "Vulnerable tracts: bottom 25% in median income & top 25% in population 65+, relative to the rest of PA\nDashed line shows 15-mile threshold used to define underserved.\nThere is a clustering of tracts with relatively close hospital access (<15 miles) and a very long tail beyond the 15 mile cutoff."
  ) +
  theme_minimal()
...
- What dataset did you choose and why?
  - I selected the polling place dataset because it includes detailed accessibility designations that make it possible to study how voting sites accommodate residents with different mobility needs. The dataset also pairs well with SEPTA bus stop locations, which I used to examine how transit access aligns with these polling sites across Philadelphia. My goal was to identify voting locations that may lack convenient bus service nearby.

- What is the data source and date?
  - The polling place information comes from OpenDataPhilly, last updated on December 8, 2014.The SEPTA bus stop data were obtained from the SEPTA Open Data Portal for 2022.
  
- How many features does it contain?
  - There are 1,703 polling sites listed within Philadelphia and 18,066 bus stops across SEPTA’s broader service area. When limited to the city’s census tracts, the number of bus stops decreases to 10,654.
...
To what extent are Philadelphia’s polling places accessible by public transit, and which ones are located beyond walking distances of 5, 10, or 15 minutes from the nearest bus stop?
...
**Your interpretation:**
Polling places located more than a five minute walk from a bus stop appear to present the most potential for further study. These sites are largely concentrated along the city’s outer edges, suggesting spatial gaps in transit coverage. Future work could assess the surrounding street environments, since a short walk through a calm residential block differs greatly from one that requires crossing high-traffic corridors. This analysis could also integrate additional layers such as polling place accessibility ratings, their presence in vulnerable census tracts, and proximity to other transit options including SEPTA rail lines, trolleys, bike share stations, and bike lanes.
